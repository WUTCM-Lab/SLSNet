...
class DecoderBlock(nn.Module):  #Cross-scale Multi-level Feature Fusion Module
    def __init__(self, in_chan, skip_chan,out_chan,reduction_ratio=1):
        ...
        self.sa = nn.Sequential(
            ...
            nn.BatchNorm2d(out_chan // reduction_ratio),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_chan//reduction_ratio, out_chan, kernel_size=1, stride=1, padding=0),
        )
...
class TCUNet(nn.Module):
    ...
    def __init__(self, img_size=512, in_chans=3, num_classes=3, base_channel=32, channel_ratio=2, use_cnn = True,
...
if __name__ == '__main__':
    ...
    # model2 = ConvBlock(3,3,res_conv=True)
